...
[otf,psf,Nn,dxn,Nz,Nzn,dzn]=model_PSF_WF(lambda,n,NA,pixelsize,magnification,N,zrange,dz);
elseif microscope==2
...
[otf,psf,Nn,dxn,Nz,Nzn,dzn]=model_PSF_2B_LSF(lambda,n,NA,pixelsize,magnification,N,zrange,dz);
end 
...
if microscope==4
    ...
    [img,VT,psf,dxn,dzn]=model_LSF_3beam(ADN,lambda,n,NA,pixelsize,magnification,N,zrange,dz);
end 
