function [img,VT,psf,Nz]=Micro_img_simulation(ADN,lambda,n,NA,pixelsize,magnification,N,zrange,dz,tau,nphot,Var_GN,Mean_GN,Cell_speed,shutter_speed,microscope,frame_rate,LSW)

if Cell_speed~=0 
    dz= Cell_speed*1/frame_rate;
end 
%% modélisation de PSF
if microscope~=4
if microscope==1
