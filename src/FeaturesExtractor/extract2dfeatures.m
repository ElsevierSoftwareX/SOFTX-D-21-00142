...
% functions.
doubleValues = arrayfun(@double, [neighboorhoodSizeGlcm, nNeighborLbp, ...
                                  radiusLbp, nLayerScattering, ...
                                  nScaleScattering, ...
                                  nOrientationScattering], ...
                        'UniformOutput', false);
[neighboorhoodSizeGlcm, nNeighborLbp, radiusLbp, nLayerScattering, ...
 nScaleScattering, nOrientationScattering] = doubleValues{:};
%% Image preparation
