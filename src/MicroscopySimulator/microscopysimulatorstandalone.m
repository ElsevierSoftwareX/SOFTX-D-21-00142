function microscopysimulatorstandalone(markerUmCsv, wavelengthUm, ...
    ...
    wienerParameter, microscope, groundTruthTif, finalImageTif, ...
...
%       wienerParameter - Double. Wiener filter parameter for 3-beam SIM
%   reconstruction (ignored for other microscopes).
...
%   2.9, 0.1, 'widefield', 'Path/to/out/gt.tif', 'Path/to/out/img.tif')
%
...
[wavelengthUm, refractiveIndex, numericalAperture, pixelSizeUm, ...
 ...
 markerIntensityPhoton, gaussianNoiseMean, gaussianNoiseStd, ...
 cellSpeedUmPerS, shutterSpeedHz, frameRateHz, lightSheetWidthUm, ...
 wienerParameter, cameraSizePx] = valuesfromstrings(...
    {wavelengthUm, refractiveIndex, numericalAperture, pixelSizeUm, ...
     magnification, axialRangeUm,  axialStepUm, bleachingTimeS, ...
     markerIntensityPhoton, gaussianNoiseMean, gaussianNoiseStd, ...
     cellSpeedUmPerS, shutterSpeedHz, frameRateHz, lightSheetWidthUm, ...
     wienerParameter}, {cameraSizePx}, {}, {});
...
%% Run simulation
[microscopyImage, groundTruthBinaryImage, psfHalfWidthPx] = ...
    microscopysimulator(markerCoordinateUm, wavelengthUm, ...
                        ...
                        markerIntensityPhoton, gaussianNoiseMean, ...
                        gaussianNoiseStd, cellSpeedUmPerS, ...
                        shutterSpeedHz, frameRateHz, lightSheetWidthUm, ...
                        wienerParameter, microscope);
...
mat2tif(finalImageTif, microscopyImage, psfHalfWidthPx)