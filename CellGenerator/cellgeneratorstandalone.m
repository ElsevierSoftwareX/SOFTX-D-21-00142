function cellgeneratorstandalone(chromatinDatabase, markerDistribution, ...
                                 nChain, radiusArbitrary, prune, ...,
                                 cellDistribution,  outputCsv, ...
...
%       nChain - Int. Number of chromatin chains (chromozomes) to model
%   inside the cell (46 for human cells).
...
%       cellDistribution - Function handle that outputs a value randomly
%   picked from the distribution of cell sizes (µm). For instance,
...
[radiusArbitrary, nChain, prune, markerDistribution, ...
 cellDistribution] = valuesfromstrings({radiusArbitrary}, {nChain}, ...
                                       {prune}, {markerDistribution, ...
                                                 cellDistribution});
...
cellSizeUm = [cellDistribution(), cellDistribution(), cellDistribution()];
